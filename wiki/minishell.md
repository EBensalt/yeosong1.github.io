...
저는 완벽하게 깔끔하게는 못했고.. 다 지나고 난 뒤에 하는 말 입니다. 제가 이걸 다시 한다면 <br>
최대한 더러운 테스트케이스를 받은 뒤 논리를 분석하고, 서브젝트랑 비교해서 안해도 되는 부분을 뺀 다음에 파싱기 짜기를 시작하면 좋을 것 같네요.. <br>

~~~
"echo" 파이프, 세미콜론, """따옴표 안에 있는 파이프와 세미콜론과 공백과 $환경변수와 $?와 "그 뒤에 따라 붙는 | 문자들..
그런 것들요!
~~~
