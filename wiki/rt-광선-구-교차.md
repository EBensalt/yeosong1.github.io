...
마지막으로 광선-구 교차점 테스트를 위한 완성된 코드가 있습니다.<br>
기하적 해법의 경우, d가 구 반경보다 크면 광선을 빨리 리젝트 할 수 있다고 언급 했습니다.<br>
그러나 그러려면 연산 비용이 드는 d2의 제곱근을 계산해야합니다.<br>
또한 d는 실제로 코드에서 사용되지 않습니다. 오직 d2만 사용 합니다.<br>
d를 계산하는 대신 d2가 radius2보다 큰지 테스트하고(이것이 Sphere 클래스의 constructor에서 radius2를 계산하는 이유임)<br>
