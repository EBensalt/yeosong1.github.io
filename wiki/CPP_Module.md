...
|--|---|---|---|---|
|케이스|베이스 클래스의 포인터 및 참조형 데이터 -> 파생 클래스의 포인터 및 참조형 데이터<br>파생 클래스의 포인터 및 참조형 데이터 -> 베이스 클래스의 포인터 및 참조형 데이터| 파생 클래스의 포인터 및 참조형 데이터 -> 베이스 클래스의 포인터 및 참조형 데이터|.|.| 
|형태|dynamic_cast<T>(변환의_대상)|dynamic_cast<T>(변환의_대상)|||
